...
telnet_test = access_method.use_telnet(switch, RouterLib.username,
                                       RouterLib.password)
...
ssh_test = access_method.use_ssh(switch, RouterLib.username,
                                 RouterLib.password)
...
"""
snmp_test = access_method.use_snmp(switch, RouterLib.snmp_read_only,
                                     'sysDescr')
"""
snmp_test = access_method.use_snmp(switch, RouterLib.snmp_read_only,
                                   '.1.3.6.1.2.1.1.1.0')
